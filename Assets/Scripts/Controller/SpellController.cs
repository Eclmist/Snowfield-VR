...
public class SpellController : MonoBehaviour
{
	...
	protected void Update()
	{
		...
		else if (controllerRef.Device != null)
		{
			...
			if (controllerRef.CurrentItemInHand == null || ((controllerRef.CurrentItemInHand is SpellHandler) && !(controllerRef.CurrentItemInHand as SpellHandler).HasSpell))
			{
	...
	protected void SwitchState()
	{
		...
		if (isActivated)
		{
			...
			currentHandler.LinkedController = controllerRef;
		}
		else
			Destroy(currentHandler);

		controllerRef.SetInteraction(currentHandler);
