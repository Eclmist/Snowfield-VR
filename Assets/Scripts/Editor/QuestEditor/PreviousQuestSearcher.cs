...
//public class HuntSearcher : EditorWindow {

//    static HuntSearcher questSearcher;
...
//    {
//        questSearcher = (HuntSearcher)EditorWindow.GetWindow(typeof(HuntSearcher));
...
//        QuestManager.QuestList = HuntFactory.Load(Path.Combine(Application.dataPath, "XML/quests.xml"));
...
//    {
//        HuntFactory.Save(Path.Combine(Application.dataPath, "XML/quests.xml"));
//    }
//}
